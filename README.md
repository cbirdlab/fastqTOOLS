...
* [ErrorRateCalculation.bash](https://github.com/cbirdlab/fastqTOOLS/blob/master/ErrorRateCalculation.bash)
  Script that outputs the propotion of sequences with insertions or deletions in the first 16bp of newRAD seq reads
* [oneLiners.bash](https://github.com/cbirdlab/fastqTOOLS/blob/master/oneLiners.bash)
  Useful oneliners to glean info from fq files
