...
* [stdDemultiplex.bash](https://github.com/cbirdlab/fastqTOOLS/blob/master/renameDemultiplex.bash)
  Script to modify PIRE Fish ID's to the desired fastq base name and add `GG` to the barcodes
